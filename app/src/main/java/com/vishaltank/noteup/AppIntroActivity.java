...
public class AppIntroActivity extends AppIntro {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance("Set reminders","Set reminder on a note to get notified about it easily!",R.drawable.reminder_ss, Color.parseColor("#404040")));
